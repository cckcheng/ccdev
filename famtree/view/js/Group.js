...
famtree.group = function() {
	...
	refreshButton.on('click', function(){this.getStore().load();}, this);
...
famtree.editGroup = function(which, ds, record){
	...
	var module_ds = new Ext.data.SimpleStore ({
                ...
                data : [
                        [0x1,'BIOS Request'],
                        //[0x1001, 'Request_Manager'],
                        [0x2,'BIOS Update'],
                        //[0x1002, 'Upgrade_Manager'],
                        [0x4,'Platform Convert'],
                        //[0x1004, 'Rework_Manager'],
                        [0x8, 'Platform'],
                        //[0x1008, 'Platform_Manager'],
                        //[0x10,'Custom_Search'],
                        //[0x1010, 'Custom_Search_Manager'],
                        [0x20,'Purchase Order'],
                        //[0x1020, 'PO_Manager'],
						[0x40,'NPI'],
                        [0x800,'Admin']
						//[0x1800, 'Admin_Manager']
                ]
        });
